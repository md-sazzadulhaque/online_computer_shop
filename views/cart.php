...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-checkout:hover { background: #c56a00; color: white; }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <div class="checkout-row">
        ...
        <a class="btn-checkout" href="/task4_23-51148-1/public/checkout.php">Proceed to Checkout &rarr;</a>
    </div>
...
function sendAjax(action, params, callback){
    ...
    xhr.open('POST', '/task4_23-51148-1/public/api/cart.php?action=' + action, true);
    xhr.onload = function(){
        if(xhr.status === 200){
